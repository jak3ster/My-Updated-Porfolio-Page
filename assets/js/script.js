...
const projects = [{
        ...
        description: 'Project 1: Price compare grab the results of searched product using Amazon and Walmart Scrapper API.',
        features: 'HTML, CSS, JavaScript, jQuery, Bootstrap, Git branching, Agile Development, Server-side APIs',
    ...
    },
    {
        ...
        features: 'HTML, CSS, Server-side API, JavaScript, jQuery, Bootstrap, Moment.js',
...
projects.forEach(proj => {
    ...
    element += `<div class="col-sm-4 col-m-12 mb-4">
                    <div class="card text-center h-100 pb-5">
